                ...
                <form id="form_categories" action="<?=_index_url;?>form/validate_categories" method="post" class="form-horizontal" role="form" novalidate="novalidate">
                    ...
                    <div id="FLD_name_holder" class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <p class="text-primary text-justify f14">ie: heavy_equipment.</p>
                        </div>
                    </div>
                    ...
                    <div id="FLD_label_holder" class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <p class="text-primary text-justify f14">ie: Heavy Equipment.</p>
                        </div>
                    </div>
                    <?php
                        echo create_csrf_token();
                        echo add_hidden_field('_return',_site_root_url.'admin/form/categories');
...
<script>
    $(function() {
        ...
        var v = $("#form_categories").validate({
            rules: {
                FLD_name: {
                    required:true,
                    regex:/^[a-zA-Z0-9_]*$/
